...
// const  = JSON.parse(localStorage.getItem('expense-list'));

// const value = JSON.parse(localStorage.getItem('col-4'));
    ...
    return {
        ...
        addListItem (inputObj) {
            ...
            if (inputObj['expenseType'] === 'savings') {
                html = '<div class="bottom-border"> <div class="column expense-column"><div class="col-2 expense-date fs-15">' + inputObj['date'] + ' </div><div class="column2 expense-text fs-15"> ' + inputObj['description'] + ' </div><div class="col-2 expense-value expense-saving fs-15"> ₹ ' + this.numberFormat(inputObj['value']) + ' </div></div>'
            } else if (inputObj['expenseType'] === 'expense') {
                html = '<div class="bottom-border"> <div class="column expense-column"><div class="col-2 expense-date fs-15">' + inputObj['date'] + ' </div><div class="column2 expense-text fs-15"> ' + inputObj['description'] + ' </div><div class="col-2 expense-value expense-cost fs-15"> ₹ ' + this.numberFormat(inputObj['value']) + ' </div></div>'
            } else if (inputObj['expenseType'] === 'investment') {
                html = '<div class="bottom-border"> <div class="column expense-column"><div class="col-2 expense-date fs-15">' + inputObj['date'] + ' </div><div class="column2 expense-text fs-15"> ' + inputObj['description'] + ' </div><div class="col-2 expense-value expense-investment fs-15"> ₹ ' + this.numberFormat(inputObj['value']) + ' </div></div>'
            }
...
function updateLS() {
    // const  = document.querySelectorAll('.expense-list');
    const expenseList = document.querySelectorAll('expense-list');
